...
class NetworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post networks_url, params: { network: { account_id: @network.account_id, name: @network.name } }
    end
  ...
  test "should update network" do
    patch network_url(@network), params: { network: { account_id: @network.account_id, name: @network.name } }
